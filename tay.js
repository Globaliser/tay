...
Element.prototype.val = function (setVal = "") {
    if (!(this instanceof HTMLInputElement ||
        ...
        throw new Error(`Expected e to be an HTMLInputElement, HTMLSelectElement, HTMLLIElement or HTMLOptionElement, but was ${(this && this.constructor && this.constructor.name) || this}`);
    if (setVal === "")
        return this.value;
    else
        this.value = setVal;
...
Element.prototype.hide = function (byDisplayNone = false) {
    if (!(this instanceof HTMLElement))
        throw new Error(`Expected e to be an HTMLElement, but was ${(this && this.constructor && this.constructor.name) || this}`);
